...
const LetterGlitch = ({
  glitchColor = ["#5e4491", "#A476FF", "#241a38"],
  glitchSpeed = 33,
  ...
  const getRandomChar = () => {
    return letterAndSymbols[
      Math.floor(Math.random() * letterAndSymbols.length)
    ];
  };

  const getRandomColor = () => {
    return glitchColor[Math.floor(Math.random() * glitchColor.length)];
  };
  ...
  return (
    <div className="relative w-full h-ful  bg-[#101010] overflow-hidden">
